...
// Posição do mouse vira variável CSS para o brilho do card
    ...
    <section id="para-voce" style={{ padding: "5rem 0", position: "relative", zIndex: 2 }}>
      <div className="container">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "0.875rem" }}>
          {profiles.map(({ Icon, color, title, desc }, i) => (
            <Reveal key={title} delay={i * 70}>
              <div className="card card-glow" onMouseMove={glow} style={{ display: "flex", gap: "0.875rem", alignItems: "center", height: "100%" }}>
        ...
        <Reveal delay={420} style={{ marginTop: "1.75rem", padding: "1rem 1.25rem", background: "rgba(192,38,211,0.05)", border: "1px solid rgba(192,38,211,0.18)", borderLeft: "3px solid var(--pink)", borderRadius: "0 12px 12px 0" }}>
